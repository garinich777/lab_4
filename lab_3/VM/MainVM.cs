...
namespace lab_4.VM
{
    public class MainVM : ViewModelBase
    {
        ...
        private bool IsTabHaveSelectedItem(string type)
        {
            if (type.ToString() == "Student")
                return ((ViewTablePage)ViewTablePage).dg_student.SelectedItem != null;
            else
                return ((ViewTablePage)ViewTablePage).dg_grades.SelectedItem != null;
        }

        private bool IsTabHaveValues(string type)
        {
